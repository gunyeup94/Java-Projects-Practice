    ...
    static class TreeNode<T> {
        ...
        private int heightHelper() {
            if (this.left == null && this.right == null) {
                ...
                int count = 1;
                if (left != null) {
                    TreeNode leftheight = left;
                    if (leftheight.heightHelper() > count) {
                        count = leftheight.heightHelper();
                    }
                }
                if (right != null) {
                    TreeNode rightheight = right;
                    if (rightheight.heightHelper() > count) {
                        count = rightheight.heightHelper();
                    }
                }
                count++;
                return count;
